...
abstract class $PokemonStatCopyWith<$Res> {
  ...
  @useResult
  $Res call({int value, PokemonStatType stat});
}
...
class _$PokemonStatImpl implements _PokemonStat {
  const _$PokemonStatImpl({required this.value, required this.stat});
...
abstract class _PokemonStat implements PokemonStat {
  const factory _PokemonStat(
      ...
      required final PokemonStatType stat}) = _$PokemonStatImpl;
